...
class Sentence:
    ...
    """
    def __init__(self, tokens, doc_id, position, phrases = None, dict_tokens_pos=None, raw_phrases=None):
        if phrases is None:
            phrases = []

        if dict_tokens_pos is None:
            dict_tokens_pos={}


        self.raw_phrases = raw_phrases or []
        ...
        self.untokenized_concepts = []
        """ concepts of the sentence in untokenized form. Tuples of same size as the concepts, but with unstemmed concepts. """
