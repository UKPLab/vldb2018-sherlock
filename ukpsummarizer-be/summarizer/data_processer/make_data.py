...
def make_data_argument_parser():
    ...
    #parse, NER
    parser.add_argument('-a', '--annotation_type', help="Annotation Type ex: parse, props", type=str, required=False)
...
def main():
    parser = make_data_argument_parser()
    ...
    if corpus_name[:3] == 'DIP':
        corpus.cleanDIP_data(parse_type)
    else:
        pass
