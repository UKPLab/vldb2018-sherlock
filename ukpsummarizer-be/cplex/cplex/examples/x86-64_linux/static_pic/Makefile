...
CPP_EX = blend cutstock etsp facility fixcost1 foodmanufact \
         ...
         iloindefqpex1 iloglobalqpex1 ilodiet \
...
execute_c: $(C_EX) $(CX_EX)
	 ...
	 ./benders $(EXDATA)/UFL_25_35_1.mps
	 ./bendersatsp 1 $(EXDATA)/atsp.dat
	 ./bendersatsp2 1 $(EXDATA)/atsp.dat
	 ./socpex1
	 ./qcpdual
	 ./adpreex1
...
execute_cpp: $(CPP_EX)
	 ...
	 ./ilobenders $(EXDATA)/UFL_25_35_1.mps
	 ./ilobendersatsp 1 $(EXDATA)/atsp.dat
	 ./ilobendersatsp2 1 $(EXDATA)/atsp.dat
	 ./ilosocpex1
	 ./iloqcpdual
	 ./inout1
	 ./inout3
